...
function Zelle({ handlePageChange }) {
    return <>
    <img
       src="img/zelleLand.jpg"
     ...
     />
    <h1 style={{ zIndex: '3', position: 'relative'}} class="text-white">Zelle Giving</h1>
    ...
    <div class="container mx-auto tm-container relative">
        ...
        <div class="flex flex-col lg:flex-row justify-around items-center lg:items-stretch">
            ...
            <div class="flex-1 rounded-xl px-10 py-12 m-5 bg-white bg-opacity-80 tm-item-container-contact" style={{ zIndex: '2', position: 'relative'}}>
                ...
                <h2 class="text-3xl mb-6 tm-text-green">Giving by Zelle<br/><br/></h2>
