...
function DirectTransfer({ handlePageChange }) {
    return <>
    <img
     ...
     />
    <h1 style={{ zIndex: '3', position: 'relative'}} class="text-black">Direct Transfer Giving/EFT</h1>
    <div id="directtransfer" class="parallax-window relative" data-parallax="scroll" data-image-src="img/St Lukes Inside Prayer.jpg">
