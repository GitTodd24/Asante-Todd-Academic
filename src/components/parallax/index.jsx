function Parallax(){
    return <>
    <div class="parallax-window w-full h-screen bg-right bg-no-repeat pr-12" data-parallax="scroll"  
    style={{ backgroundImage: "url('public/img/Choir2Landscape2.jpg')", backgroundPosition: "right center", backgroundSize: "cover" }}>
               <div class="text-center mb-16">
                <h2 class="bg-white tm-text-brown py-6 px-12 text-4xl font-medium inline-block rounded-md">Our Cafe Menu</h2>
            </div>            
            <div class="lg:flex-row justify-around items-center">
                <div class="m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="items-start mb-6 tm-menu-item">
   ...
   <div id="about" class="parallax-window" data-parallax="scroll" data-image-src="img/antique-cafe-bg-03.jpg">
    ...
    <div id="contact" class="parallax-window relative" data-parallax="scroll" data-image-src="img/pngtree-university-lecture-hall.jpg">
