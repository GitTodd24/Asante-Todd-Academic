...
function Lectures({ handlePageChange }) {
       return (
        <>
             {/* <img src="img/classFull.jpeg" alt="Image Description" className="absolute" style={{ top: '0', left: '40', width: '100%', height: 'auto', marginTop: '0', zIndex: '1', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} /> */}
              <h1 style={{ zIndex: '3', position: 'relative', color: 'black' }}>Lectures</h1>
                    ...
                    <div className="lg:items-stretch">
                        ...
                        <div className="rounded-xl px-10 py-12 bg-white bg-opacity-80 tm-item-container-contact max-w-fit" style={{ zIndex: '2', position: 'relative', marginTop: "-50px" }}>
                            ...
                            <p className="mb-6 text-lg leading-8">
                                My research spans the gamut from religion and politics to philosophy and aesthetics. I have published in a variety of venues, including academic journals, edited volumes, and manuscripts.<br /><br />
                                ...
                                Click a button below to browse lectures by area of study OR click "Contact" in the top navigation bar to inquire about <span onClick={() => handlePageChange('Contact')} className="underline text-blue-500 cursor-pointer">lectures, adjunct, and online teaching</span>.
                                          </p>
                        ...
                        <div className="flex-1 rounded-xl p-12 pb-14 m-5 bg-black bg-opacity-50 tm-item-container" style={{ marginLeft: "575px", marginTop: "-1300px", zIndex: '2', position: 'relative' }}>
                            <form action="" method="POST" className="text-lg">
                                ...
                                <div className="input bg-black border-b bg-opacity-0 text-white px-0 py-4 mb-4 tm-border-gold">
                                    ...
                                    Cornel West, the Cultural Politics of Difference, and African American Prophetic Christianity<br /><br />
                                    Pentecostalism<br /><br />
                                    T.D. Jakes, the Black MegaChurch, and Prosperity Gospel<br /><br />
                                    Molefi K. Asante on Traditional African Religions<br /><br />
